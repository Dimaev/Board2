...
/**
  ...
  \param proposedContentOffset The proposed point for the
...
/**
  ...
  just selected.
*/
@property (nonatomic) BOOL rangeSelectionWillBeUsed;
/**
  Lays out subviews.
*/
- (void)layoutSubviews;
...
@interface JTAppleCalendarView (SWIFT_EXTENSION(JTAppleCalendar)) <UICollectionViewDelegate, UICollectionViewDataSource>
/**
...
*/
- (NSArray<NSDate *> * _Nonnull)generateDateRangeFrom:(NSDate * _Nonnull)startDate to:(NSDate * _Nonnull)endDate;
/**
  ...
  \param bundle The bundle where the xib can be found.
  If left nil, the library will search the
  main bundle

*/
- (void)registerCellViewXibWithFile:(NSString * _Nonnull)name bundle:(NSBundle * _Nullable)bundle;
/**
...
*/
- (void)registerCellViewClassWithFile:(NSString * _Nonnull)name bundle:(NSBundle * _Nullable)bundle;
/**
  Let’s the calendar know which cell
  class to use for the displaying of it’s date-cells.
  \param type The type of your cell design

*/
- (void)registerCellViewClassWithType:(Class _Nonnull)type;
/**
  Register header views with the calender. This needs to be done
  before the view can be displayed
  \param xibFileNames An array of xib file string names

  \param bundle The bundle where the xibs can be found.
  If left nil, the library will search the
  main bundle

*/
- (void)registerHeaderViewWithXibFileNames:(NSArray<NSString *> * _Nonnull)xibFileNames bundle:(NSBundle * _Nullable)bundle;
/**
  Register header views with the calender. This needs to be
  done before header views can be displayed
  \param classStringNames An array of class string names

  \param bundle The bundle where the xibs can be found. If left
  nil, the library will search the main bundle

*/
- (void)registerHeaderViewWithClassStringNames:(NSArray<NSString *> * _Nonnull)classStringNames bundle:(NSBundle * _Nullable)bundle;
/**
  Register header views with the calender. This needs to be done
  before header views can be displayed
  \param classTypeNames An array of class types

*/
- (void)registerHeaderViewWithClassTypeNames:(NSArray<Class> * _Nonnull)classTypeNames;
/**
...
*/
- (void)reloadDataWithAnchor:(NSDate * _Nullable)date animation:(BOOL)animation completionHandler:(void (^ _Nullable)(void))completionHandler;
/**
...
*/
@property (nonatomic, strong) JTAppleDayCellView * _Nullable view;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
/**
  Returns an object initialized from data in a given unarchiver.
*/
